        ...
        <div className="container">
          <div data-custom-class="body">
            <div align="center" style={{ textAlign: "left" }}>
              ...
              >
                ...
                >
                  ...
                  >
                    <bdt className="question">Onlyface</bdt> is licensed to You
                    (End-User) by <bdt className="question">Onlyface Inc.</bdt>,
                    located
                    <bdt className="block-component" /> and registered
                    <bdt className="statement-end-if-in-editor" /> at{" "}
                    <bdt className="question">
                      5F., No. 57, Fuhua St., Fengshan Dist.,
                    </bdt>
                    ,
                    <span
                      style={{
                    ...
                    >
                      ...
                      <bdt className="question">Kaohsiung City</bdt>,{" "}
                      <bdt className="block-component" />
                      <bdt className="question">Taiwan (R.O.C.)</bdt>
                      <bdt className="statement-end-if-in-editor" />{" "}
                      <bdt className="question">83070</bdt>
                      <span style={{ fontSize: 15 }}>
                        <bdt className="block-component" />,{" "}
                        <bdt className="question">Taiwan</bdt>
                        <bdt className="statement-end-if-in-editor" />
                        &nbsp;
                      </span>
                    </span>
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    "Play Store"
                    <bdt className="statement-end-if-in-editor" />)
                    <bdt className="statement-end-if-in-editor" />, and any
                    update thereto (as permitted by this{" "}
                    <bdt className="block-component" />
                    License
                    <bdt className="statement-end-if-in-editor" /> Agreement),
                    You indicate that You agree to be bound by all of the terms
                    and conditions of this <bdt className="block-component" />
                    License
                    <bdt className="statement-end-if-in-editor" /> Agreement,
                    and that You accept this <bdt className="block-component" />
                    License
                    <bdt className="statement-end-if-in-editor" /> Agreement.{" "}
                    <bdt className="block-component" />
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <bdt className="block-component" />
                    License
                    <bdt className="statement-end-if-in-editor" /> Agreement and
                    are not bound by any provisions or obligations with regard
                    to the Licensed Application, such as warranty, liability,
                    maintenance and support thereof.{" "}
                    <bdt className="question">Onlyface Inc.</bdt>, not the
                    Services, is solely responsible for the Licensed Application
              ...
              >
                  ...
                  <bdt data-type="conditional-block">
                    <span style={{ fontSize: 15 }}>
                      <bdt data-type="body">
                        ...
                        >
                          <bdt className="question">Onlyface Inc.</bdt>{" "}
                ...
                <div
                  ...
                  style={{ lineHeight: "1.5" }}
                >
                  <bdt className="question">Onlyface</bdt>{" "}
                  <bdt data-type="conditional-block">
                    <span style={{ fontSize: 15 }}>
                      <bdt data-type="body">
                        <span
                        ...
                        >
                          ...
                          <bdt className="question">Onlyface</bdt> is to be used
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <bdt className="statement-end-if-in-editor" />) is a piece
                    of software created to{" "}
                    <bdt className="question">
                      Onlyface is more than an app; it's a sanctuary for
                      individuals who recognize the power of genuine
                      connections. By allowing users to curate their community
                      based on good looks and genuine appeal, Onlyface creates a
                      space where authenticity and aesthetics harmonize. Our
                      purpose is to bring together like-minded, attractive
                      people, fostering meaningful relationships and authentic
                      friendships in a world that values both inner and outer
                      beauty. Join Onlyface today and experience connections
                      that transcend the surface, celebrating the beauty in
                      every smile and the authenticity in every conversation.
                    </bdt>{" "}
                    ...
                    <bdt className="block-component" />
                    Android
                    <bdt className="statement-end-if-in-editor" /> mobile
                    devices (
                    ...
                    <bdt className="question">
                      Onlyface is your gateway to authentic connections in a
                      visually driven world. It's a platform that celebrates
                      both inner and outer beauty, connecting individuals who
                      appreciate genuine relationships and a captivating smile.
                      Users can engage in real conversations, form lasting
                      friendships, and build a social circle based on mutual
                      respect and shared appreciation for aesthetics. Whether
                      you’re here to find friends, network, or even something
                      more, Onlyface is where good looks and genuine connections
                      intersect.
                    </bdt>
                    .<bdt className="block-component" />
                  </span>
                                  ...
                                  <bdt data-type="conditional-block">
                                    <bdt data-type="body">
                                      ...
                                      >
                                        ...
                                        Application on any Devices that You
                                        (End-User) own or control and as
                                        permitted by the Usage Rules, with the
                                        exception that such Licensed Application
                                        may be accessed and used by other
                                        accounts associated with You (End-User,
                                        The Purchaser) via Family Sharing or
                                        volume purchasing.
                                      </span>
                                    </bdt>
                                  </bdt>
                                  ...
                                  <bdt data-type="conditional-block">
                                    <bdt data-type="body">
                                      ...
                                      >
                                        ...
                                        license
                                        <bdt className="statement-end-if-in-editor" />{" "}
                                        will also govern any updates of the
                                        Licensed Application provided by
                                        Licensor that replace, repair, and/or
                                        supplement the first Licensed
                                        Application, unless a separate{" "}
                                        <bdt className="block-component" />
                                        license
                                        <bdt className="statement-end-if-in-editor" />{" "}
                                        is provided for such update, in which
                                        case the terms of that new{" "}
                                        <bdt className="block-component" />
                                        license
                                        <bdt className="statement-end-if-in-editor" />{" "}
                                        will govern.
                              ...
                              >
                                <bdt data-type="conditional-block">
                                  <bdt data-type="body">
                                    ...
                                    >
                                      3 &nbsp;You may not share or make the
                                      Licensed Application available to third
                                      parties (unless to the degree allowed by
                                      the Usage Rules, and with{" "}
                                      <bdt className="question">
                                        Onlyface Inc.
                                      </bdt>
                                  ...
                                  <bdt data-type="conditional-block">
                                    <bdt data-type="body">
                                      <span
                                        style={{ color: "rgb(89, 89, 89)" }}
                                      >
                                        4 &nbsp;You may not reverse engineer,
                                        translate, disassemble, integrate,
                                        decompile, remove, modify, combine,
                                        create derivative works or updates of,
                                        adapt, or attempt to derive the source
                                        code of the Licensed Application, or any
                                  ...
                                  <bdt data-type="conditional-block">
                                    <bdt data-type="body">
                                      ...
                                      >
                                        ...
                                        thereof. You may create and store copies
                                        only on devices that You own or control
                                        for backup keeping under the terms of
                                        this <bdt className="block-component" />
                                        license
                                        <bdt className="statement-end-if-in-editor" />
                                        , the Usage Rules, and any other terms
                                        and conditions that apply to the device
                                        or software used. You may not remove any
                                        ...
                                        copies at any time. If you sell your
                                        Devices to a third party, you must
                                        remove the Licensed Application from the
                                  ...
                                  <bdt data-type="conditional-block">
                                    <bdt data-type="body">
                                      <span
                                        style={{ color: "rgb(89, 89, 89)" }}
                                      >
                                        6 &nbsp;Violations of the obligations
                                  ...
                                  <bdt data-type="conditional-block">
                                    <bdt data-type="body">
                                      <span
                                        style={{ color: "rgb(89, 89, 89)" }}
                                      >
                                        7 &nbsp;Licensor reserves the right to
                                  ...
                                  <bdt data-type="conditional-block">
                                    <bdt data-type="body">
                                      ...
                                      >
                                        ...
                                        Licensed Application, You must ensure
                                        that You comply with applicable
              ...
              >
                                  ...
                                  <bdt data-type="conditional-block">
                                    <bdt data-type="body">
                                      ...
                                      >
                                        ...
                                        requires a firmware version{" "}
                                        <bdt className="block-component" />
                                        1.0.0 or higher
                                        <bdt className="else-block" />. Licensor
                                        recommends using the latest version of
                                        the firmware.
                                        <span style={{ fontSize: 15 }}>
                                          <bdt className="statement-end-if-in-editor">
                                            <bdt className="block-component" />
                                  ...
                                  <bdt data-type="conditional-block">
                                    <bdt data-type="body">
                                      <span
                                        style={{ color: "rgb(89, 89, 89)" }}
                                      >
                                        2 &nbsp;Licensor attempts to keep the
                                        Licensed Application updated so that it
                                        complies with modified/new versions of
                                        the firmware and new hardware. You are
                                        not granted rights to claim such an
                                        update.
                                        <span style={{ fontSize: 15 }}>
                                          <span
                                            style={{
                                  ...
                                  <bdt data-type="conditional-block">
                                    <bdt data-type="body">
                                      ...
                                      >
                                        ...
                                        You intend to use the Licensed
                                        Application satisfies the technical
                                  ...
                                  <bdt data-type="conditional-block">
                                    <bdt data-type="body">
                                      <span
                                        style={{ color: "rgb(89, 89, 89)" }}
                                      >
                                        4 &nbsp;Licensor reserves the right to
                ...
                >
                  ...
                  >
                    ...
                    listed in the <bdt className="block-component" />
                    App Store
                    <bdt className="statement-end-if-in-editor" />
                    <bdt className="block-component" /> or{" "}
                    <bdt className="statement-end-if-in-editor" />
                    <bdt className="block-component" />
                    Play Store
                    <bdt className="statement-end-if-in-editor" /> Overview for
                                    ...
                                    <bdt data-type="body">
                                      ...
                                      <font color="#595959">
                                        <span style={{ fontSize: 15 }}>
                                          ...
                                          Services have no obligation whatsoever
                                  ...
                                  <bdt data-type="conditional-block">
                                    <bdt data-type="body">
                                      ...
                                      >
                                        ...
                                        <bdt className="question">
                                          <a
                                            href="https://onlyface-web.vercel.app/privacy"
                                            target="_blank"
                                            data-custom-class="link"
                                          >
                                            https://onlyface-web.vercel.app/privacy
                                          </a>
                                        </bdt>
                                        <bdt className="block-component" />.
                                      </span>
                                ...
                                >
                                  <bdt data-type="conditional-block">
                                    <bdt data-type="body">
                                      ...
                                      >
                                        <bdt className="block-component" />
                                        The Licensed Application may invite you
                                        to chat, contribute to, or participate
                                        in blogs, message boards, online forums,
                                        ...
                                        in the Licensed Application, including
                                        but not limited to text, writings,
                                        ...
                                        other users of the Licensed Application
                                        and through third-party websites or
                                        applications. As such, any Contributions
                ...
                >
                  <span style={{ fontSize: 15 }}>
                    ...
                    <bdt className="block-component" />
                    License
                    <bdt className="statement-end-if-in-editor" /> Agreement, or
                ...
                >
                  <span style={{ fontSize: 15 }}>
                    ...
                    Application or making Contributions accessible to the
                    Licensed Application by linking your account from the
                    Licensed Application to any of your social networking
                    ...
                    worldwide right, and <bdt className="block-component" />
                    license
                    <bdt className="statement-end-if-in-editor" /> to host, use
                    copy, reproduce, disclose, sell, resell, publish, broad
                ...
                >
                  <span style={{ fontSize: 15 }}>
                    ...
                    provided by you in any area in the Licensed Application. You
                    are solely responsible for your Contributions to the
                    Licensed Application and you expressly agree to exonerate us
                    from any and all responsibility and to refrain from any
                                  ...
                                  <bdt data-type="conditional-block">
                                    <bdt data-type="body">
                                      ...
                                      >
                                        ...
                                        <bdt className="else-block" />
                                        .1 &nbsp;Licensor's responsibility in
                                        the case of violation of obligations and
                                        tort shall be limited to intent and
                                        gross negligence. Only in case of a
                                        breach of essential contractual duties
                                        (cardinal obligations), Licensor shall
                                        also be liable in case of slight
                                        negligence. In any case, liability shall
                                        be limited to the foreseeable,
                                        contractually typical damages. The
                                        limitation mentioned above does not
                                        apply to injuries to life, limb, or
                                        health.
                                        <span style={{ fontSize: 15 }}>
                                          <bdt className="statement-end-if-in-editor">
                                            <bdt className="block-component" />
                                  ...
                                  <bdt data-type="conditional-block">
                                    <bdt data-type="body">
                                      ...
                                      >
                                        ...
                                        <bdt className="else-block" />
                                        .2 &nbsp;Licensor takes no
                                        accountability or responsibility for any
                                        damages caused due to a breach of duties
                                        according to Section 2 of this{" "}
                                        <bdt className="block-component" />
                                        License
                                        <bdt className="statement-end-if-in-editor" />{" "}
                                        Agreement. To avoid data loss, You are
                                        required to make use of backup functions
                                        of the Licensed Application to the
                                        extent allowed by applicable third-party
                                        terms and conditions of use. You are
              ...
              <span style={{ fontSize: 15 }}>
                ...
                >
                  ...
                  >
                    ...
                    <bdt className="else-block" />
                    .1 &nbsp;Licensor warrants that the Licensed Application is
                    free of spyware, trojan horses, viruses, or any other
                              ...
                              <bdt data-type="conditional-block">
                                <bdt data-type="body">
                                  <span style={{ color: "rgb(89, 89, 89)" }}>
                                    ...
                                    Licensed Application that is not executable
                                    on the device, that has been{" "}
                                    <bdt className="block-component" />
                                    unauthorizedly
                                    <bdt className="statement-end-if-in-editor" />{" "}
                              ...
                              <bdt data-type="conditional-block">
                                <bdt data-type="body">
                                  <span style={{ color: "rgb(89, 89, 89)" }}>
                                    ...
                                    consideration and further investigated if it
                                    has been emailed within a period of{" "}
                                    <bdt className="question">ninety (90)</bdt>{" "}
            ...
            <div style={{ textAlign: "left", lineHeight: 1 }}>
              ...
              >
                <bdt className="question">
                  <span style={{ fontSize: 15 }}>Onlyface Inc.</span>
                </bdt>
                ...
                >
                  ledge that <bdt className="question">Onlyface Inc.</bdt>, and
                  not the Services, is responsible for addressing any claims of
                  ...
                  <bdt data-type="body">
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          , including in connection with Your Licensed
                  ...
                  <bdt data-type="body">
                    ...
                    >
                      ...
                      >
                        ...
                        <bdt className="statement-end-if-in-editor" /> country;
                        and that You are not listed on any US Government list of
                ...
                <bdt data-type="conditional-block">
                  <bdt data-type="body">
                    ...
                    >
                      ...
                      >
                        <bdt className="question">prettyfaceowner</bdt>
                      </span>
                    </div>
                  </bdt>
                </bdt>
                  ...
                  <bdt data-type="body">
                    ...
                    >
                      ...
                      >
                        ...
                        license
                        <bdt className="statement-end-if-in-editor" /> is valid
                        until terminated by{" "}
                        <bdt className="question">Onlyface Inc.</bdt> or by You.
                        Your rights under this{" "}
                        <bdt className="block-component" />
                        license
                        <bdt className="statement-end-if-in-editor" /> will
                        terminate automatically and without notice from{" "}
                        <bdt className="question">Onlyface Inc.</bdt> if You
            ...
            <div style={{ textAlign: "left" }}>
              ...
              >
                ...
                >
                  <bdt className="question">Onlyface Inc.</bdt> represents and
                  warrants that <bdt className="question">Onlyface Inc.</bdt>{" "}
            ...
            <div style={{ textAlign: "left" }}>
              ...
              >
                ...
                >
                  ...
                  <bdt className="block-component" /> will have the right (and
                  will be deemed to have accepted the right) to enforce this End
                  User <bdt className="block-component" />
                  License
                  <bdt className="statement-end-if-in-editor" /> Agreement
            ...
            <div style={{ textAlign: "left" }}>
              ...
              >
                ...
                >
                  <bdt className="question">Onlyface Inc.</bdt> and the End-User
                  acknowledge that, in the event of any third-party claim that
                  the Licensed Application or the End-User's possession and use
                  of that Licensed Application infringes on the third party's
                  intellectual property rights,{" "}
                  <bdt className="question">Onlyface Inc.</bdt>, and not the
                  Services, will be solely responsible for the investigation,{" "}
                  <bdt className="block-component" />
                  defense
                  <bdt className="statement-end-if-in-editor" />, settlement,
            ...
            <div style={{ textAlign: "left" }}>
              ...
              >
                ...
                >
                  ...
                  governed by the laws of <bdt className="block-component" />
                  <bdt className="question">Taiwan</bdt>
                  <bdt className="statement-end-if-in-editor" /> excluding its
                    ...
                    <bdt data-type="body">
                      ...
                      >
                        ...
                        >
                          ...
                          valid if laid down in writing. The preceding clause
